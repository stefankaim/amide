...
/* ./.libs/lt-amide.c - temporary wrapper executable for .libs/amide.exe
   Generated by libtool (GNU libtool) 2.5.4

   The amide program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:\\msys64\\mingw64\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;C:\\msys64\\usr\\lib;C:\\msys64\\usr\\bin;C:\\msys64\\usr\\local\\dicom\\lib;C:\\msys64\\usr\\local\\dicom\\bin;C:\\msys64\\usr\\lib64\\dcmtk;C:\\msys64\\usr\\lib\\dcmtk;";
const char * TARGET_PROGRAM_NAME = "amide.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# amide - temporary wrapper script for .libs/amide.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The amide program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' /mingw64/lib/libmdc.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"amide.exe:amide:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"amide.exe:amide:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"amide.exe:amide:$LINENO: newargv[0]: $progdir\\\\$program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/mingw64/lib:/mingw64/bin:/usr/lib:/usr/bin:/usr/local/dicom/lib:/usr/", f);
  fputs ("local/dicom/bin:/usr/lib64/dcmtk:/usr/lib/dcmtk:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/mingw64/lib:$PATH\"\n", f);
  fputs ("\n", f);
